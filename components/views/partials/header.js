          ...
          <div>
            <div className="container text-center">
              ...
              <nav className="navbar navbar-default" >
                <div className="container-fluid" style={{ marginLeft: '38%' }}>
                      ...
                      <ul className="nav navbar-nav" >
                        {
                                    !!nav.metafields && nav.metafields.map((navElement, index) => (
                                      <li key={`nav_${index}`}>
                                        ...
                                        {!!navElement.children && <a className="dropdown-toggle" data-toggle="dropdown" href="#">{navElement.title}<span className="caret" /></a>}
